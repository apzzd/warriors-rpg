...
class Player extends TileSprite {
    constructor(controls) {
        ...
        anims.add("walkf", [{x: 3, y: 0}, {x: 4, y: 0}, {x:5 , y:0}, {x: 3, y: 0}], 0.1)
        anims.add("walkl", [{x: 3, y: 1}, {x: 4, y: 1}, {x:5 , y:1}, {x: 3, y: 1}], 0.1)
        anims.add("walkr", [{x: 3, y: 2}, {x: 4, y: 2}, {x:5 , y:2}, {x: 3, y: 2}], 0.1)
        anims.add("walkb", [{x: 3, y: 3}, {x: 4, y: 3}, {x:5 , y:3}, {x: 3, y: 3}], 0.1)
